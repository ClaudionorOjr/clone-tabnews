...
time <!-- Comando para verificar quanto tempo levou a execução de algum outro comando. Ex.: time npm test -->  
HEAD~_n_commits_ <!-- Esse comando indica que a partir da HEAD de commits vai retornar um dado número de commits -->
